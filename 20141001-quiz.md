...
起點
``` js
function show(arrayOfInteger, lowerbound, upperbound){
...
//demo
console.log("show(a,3,10)");
show(a,3,10);   //show x where 3<x<10
console.log("show(a,5,7)");
show(a,5,7);    //show x where 5<x<7
```
> 作者：hsine
